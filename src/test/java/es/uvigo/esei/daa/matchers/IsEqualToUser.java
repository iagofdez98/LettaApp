...
public class IsEqualToUser extends IsEqualToEntity<User> {
	...
	/**
	 * Factory method that creates a new {@link IsEqualToEntity} matcher with the
	 * provided {@link Person} as the expected value.
	 * 
	 ...
	 * @return a new {@link Matcher} that includes several {@link IsEqualToUser}
	 *         matchers, each one using an {@link Person} of the provided ones as
	 *         the expected value.
	 * @see IsEqualToEntity#containsEntityInAnyOrder(java.util.function.Function,
	 *      Object...)
	 */
	@Factory
